...
class ThemeProvider extends ChangeNotifier {
  ...
  void setTheme(ThemeMode themeMode) {
    ProCache.getInstance().setString(Constant.theme, themeMode.value);
    notifyListeners();
  }
  ...
  ThemeData getTheme({bool isDarkMode = false}) {
    return ThemeData(
      ...
      scaffoldBackgroundColor:
          isDarkMode ? Colours.dark_bg_color : Colors.grey[100],
      // 主要用于Material背景色
